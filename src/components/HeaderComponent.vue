      ...
      <div class="header-mid header-sticky">
        <div class="container">
              ...
              <ul>
                <li>
                  <div class="nav-search search-switch hearer_icon">
                    <a href="javascript:void(0)" id="search_1">
          ...
          <div class="search_input" id="search_input_box">
            <!-- <form class="search-inner s-flex justify-content-between">
          ...
          <!-- <div class="col-12">
                        <div class="mobile_menu d-block-d-lg-none">
                            <div class="slicknav_menu">
                                ...
                                <ul class="slick_nav slicknav_hidden" aria-hidden="true" role="menu">
                                    <li><a href="index.html" role="menuitem" tabindex="-1">Home</a></li>
                                    <li><a href="categories.html" role="menuitem" tabindex="-1">Men</a></li>
                                    <li><a href="categories.hmtl" role="menuitem" tabindex="-1">Women</a></li>
                                    ...
                                    <li class="slicknav_collapsed slicknav_parent">
                                        <a href="#" role="menuitem" aria-haspopup="true" tabindex="-1" class="slicknav_item.slicknav_row">
                                            <a href="#" tabindex="-1"></a>"Pages"
                                            <span class="slicknav_arrow">+</span>
                                        </a>
                                        <ul class="submenu slicknav_hidden" role="menu" aria-hidden="true"></ul>
                                    </li>
                                    <li class="slicknav_collapsed slicknav_parent">
                                        <a href="#" role="menuitem" aria-haspopup="true" tabindex="-1" class="slicknav_item.slicknav_row">
                                        ...
                                        <ul class="submenu slicknav_hidden" role="menu" aria-hidden="true">
                                          ...
                                          <li>
                                              <a href="blog-details.html" role="menuitem" tabindex="-1">Blog Details</a>
                                          </li>  
                                        </ul>
                                    </li>
